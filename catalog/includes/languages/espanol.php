...
define('TEXT_GREETING_PERSONAL', '&iexcl;Bienvenido de nuevo <span class="greetUser">%s!</span> Le gustar&iacute;a ver que <a href="%s"><u>nuevos productos</u></a> hay disponibles para comprar ?');
...
define('FOOTER_TEXT_BODY', 'Derechos Reservados &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a></>');
?>
