...
define('TEXT_BANNERS_OR_AT', ', o tr&aacute;s');
define('TEXT_BANNERS_IMPRESSIONS', 'vistas.');
define('TEXT_BANNERS_SCHEDULED_AT', 'Programado el:');
define('TEXT_BANNERS_BANNER_NOTE', '<strong>Notas sobre el Banner:</strong><ul><li>Use una imagen o texto HTML para el banner - no ambos.</li><li>Texto HTML tiene prioridad sobre una imagen</li></ul>');
...
define('TEXT_BANNERS_EXPIRCY_NOTE', '<strong>Notas sobre la Caducidad:</strong><ul><li>Solo se debe de rellenar uno de los dos campos</li><li>Si el banner no debe de caducar no rellene ninguno de los campos</li></ul>');
define('TEXT_BANNERS_SCHEDULE_NOTE', '<strong>Notas sobre la Programaci&oacute;n:</strong><ul><li>Si se configura una fecha de programaci&oacute;n el banner se activar&aacute; en esa fecha.</li><li>Todos los banners programados se marcan como inactivos hasta que llegue su fecha, cuando se marcan activos.</li></ul>');
...
define('TEXT_BANNERS_LAST_3_DAYS', 'Ultimos 3 d&iacute;as');
...
define('SUCCESS_BANNER_INSERTED', 'Exito: El banner ha sido insertado.');
define('SUCCESS_BANNER_UPDATED', 'Exito: El banner ha sido actualizado.');
define('SUCCESS_BANNER_REMOVED', 'Exito: El banner ha sido eliminado.');
define('SUCCESS_BANNER_STATUS_UPDATED', 'Exito: El estado del banner ha sido actualizado.');
...
define('ERROR_GRAPHS_DIRECTORY_DOES_NOT_EXIST', 'Error: El directorio de gr&aacute;ficos no existe. Por favor, cree un directorio \'graphs\' dentro de \'images\'.');
