...
define('TEXT_INFO_UNPACK', '<br /><br />(despu&eacute;s de descomprimir el archivo)');
define('TEXT_INFO_RESTORE', 'No interrumpa el proceso de restauraci&oacute;n.<br><br>&iexcl;Cuanto mas grande sea la copia de seguridad, mas tardar&aacute; este proceso!<br><br>Si es posible, use el cliente de mysql.<br><br>Por ejemplo:<br><br><b>mysql -h' . DB_SERVER . ' -u' . DB_SERVER_USERNAME . ' -p ' . DB_DATABASE . ' < %s </b> %s');
...
define('SUCCESS_LAST_RESTORE_CLEARED', 'Exito: La &uacute;ltima fecha de restauraci&oacute;n ha sido borrada.');
