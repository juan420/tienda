...
// page title
define('TITLE', 'Herramienta de Administraci&oacute;n de osCommerce Online Merchant');
...
define('BOX_TOOLS_BACKUP', 'Resguardo de Base de Datos');
...
// javascript messages
define('JS_ERROR', '&iexcl;Existe errores procesando su formulario!\nPor favor, realice las siguientes modificaciones:\n\n');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '&nbsp;<span class="errorText">&iexcl;El correo electr&oacute;nico no es v&aacute;lido !</span>');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', '&nbsp;<span class="errorText">&iexcl;El correo electr&oacute;nico ya existe ! </span>');
